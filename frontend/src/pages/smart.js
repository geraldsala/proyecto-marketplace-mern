  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const smartProducts = productsFromAPI.filter(p => p.categoria === 'Smart Home');
    ...
    <div className="smart-page">
      <Container fluid className="pt-3">
        ...
        <Row className="align-items-center g-3 px-2">
            <Col xs="12" className="breadcrumbs"><small><span className="crumb">Inicio</span> / <span className="crumb">Tecnología</span> / <strong>Smart Home</strong></small></Col>
