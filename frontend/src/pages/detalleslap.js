...
export default function DetallesLap() {
  const { id } = useParams();
  ...
  const [myRate, setMyRate] = useState(0);   // rating usuario
        ...
        <Col lg={6}>
          <div className="card border-0 shadow-sm p-3 h-100 d-flex">
            ...
            <div className="seller mt-2">
              ...
              <strong>{product.tienda?.nombreTienda || 'La Tienda de Tecnología'}</strong>
            </div>

            {/* Rating */}
            <div className="mt-2">
              <Stars value={product.rating} />
              <span className="ms-2 text-muted">{product.rating.toFixed(1)} / 5 (ejemplo)</span>
            </div>
      ...
      <Row className="mt-4 gy-4">
        ...
        <Col lg={4}>
          ...
          <div className="card border-0 shadow-sm p-3">
            ...
            <div><strong>Tienda:</strong> {product.tienda?.nombreTienda || 'La Tienda de Tecnología'}</div>
          </div>
